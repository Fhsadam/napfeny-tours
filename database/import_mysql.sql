-- Napfény Tours - MySQL import script
...
DROP TABLE IF EXISTS tavasz;

DROP TABLE IF EXISTS szalloda;

DROP TABLE IF EXISTS helyseg;
...
CREATE TABLE szalloda (
  ...
  CONSTRAINT fk_szalloda_helyseg FOREIGN KEY (helyseg_az) REFERENCES helyseg(az)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE tavasz (
  ...
  szalloda_az VARCHAR(10) NOT NULL,
  indulas DATE NOT NULL,
  idotartam INT NOT NULL,
  ar INT NOT NULL,
  CONSTRAINT fk_tavasz_szalloda FOREIGN KEY (szalloda_az) REFERENCES szalloda(az) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO tavasz (szalloda_az, indulas, idotartam, ar) VALUES
...
INSERT INTO users (id, last_name, first_name, login_name, password_hash, created_at) VALUES
(1, 'Teszt', 'Felhasználó', 'demo', '$2y$12$eXkCUqhwI74w8TSdSEdhuu8TGIAGuFZq4c9fB5XE9D90/QK9n0ysu', '2026-04-16 10:00:00'),
(2, 'Kovács', 'Anna', 'anna.kovacs', '$2y$12$eXkCUqhwI74w8TSdSEdhuu8TGIAGuFZq4c9fB5XE9D90/QK9n0ysu', '2026-04-16 10:05:00');

INSERT INTO messages (id, user_id, sender_name, email, subject, message, created_at) VALUES
(1, 1, 'Teszt Felhasználó', 'demo@example.com', 'Foglalási kérdés', 'Érdeklődöm a legkedvezőbb tavaszi ajánlatok iránt.', '2026-04-16 11:15:00'),
(2, NULL, 'Minta Vendég', 'vendeg@example.com', 'Nyitvatartás', 'Mikor érhető el személyesen az iroda Budapesten?', '2026-04-16 12:30:00');

INSERT INTO gallery_images (id, user_id, title, filename, uploaded_at) VALUES
(1, 1, 'Málta panoráma', 'seed-1.jpg', '2026-04-16 13:00:00'),
(2, 2, 'Török riviéra este', 'seed-2.jpg', '2026-04-16 13:05:00'),
(3, 1, 'Kréta partvidék', 'seed-3.jpg', '2026-04-16 13:10:00');